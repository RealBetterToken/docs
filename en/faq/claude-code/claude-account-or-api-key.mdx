...
description: "Understand the difference between Claude.ai login, Claude Console API, cloud providers, and third-party API gateways in Claude Code. Includes setup guidance."
---
