...
description: "Connect Kimi K3 to Claude Code manually. Set a BetterToken API Key, Base URL, and kimi-k3 model mappings in settings.json or VS Code. Practical guidance."
keywords:
  - "kimi k3 claude code"
  - "kimi k3 api"
