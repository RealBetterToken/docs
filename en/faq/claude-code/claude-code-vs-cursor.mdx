...
description: "Compare Claude Code and Cursor for local projects, editor integration, rules files, MCP, model setup, and permission control. Includes examples and fixes."
---
...
Claude Code usually uses `{{anthropic-base-url}}`. Cursor and similar external tools usually use `{{openai-base-url}}`, with model IDs copied from the **GPT provider**.
