...
If you connect Claude Code through LLMEasy, copy the current model ID from the <a href={"{{model-plaza-url}}"}>model plaza</a>. Claude Key group and GPT Key group models belong to different protocol paths, so do not mix them.
