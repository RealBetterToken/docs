...
description: "Understand /model, model aliases, full model IDs, provider differences, and cost impact in Claude Code. Covers setup, expected behavior, and common fixes."
---
