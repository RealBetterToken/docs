...
description: "Understand what CLAUDE.md does in Claude Code, what to include, what to avoid, and how it differs from hooks and MCP. Includes setup, examples, and fixes."
---
