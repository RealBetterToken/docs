...
LLMEasy provides two endpoint types: the Anthropic-compatible `{{anthropic-base-url}}` for Claude Code and the OpenAI-compatible `{{openai-base-url}}` for Codex and external tools.
