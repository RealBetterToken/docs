...
description: "Understand prompt caching, cache hit fields, protocol differences, and how to check whether a request used cached tokens. Includes setup, examples, and fixes."
---
