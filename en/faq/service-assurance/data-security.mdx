---
title: "How does LLMEasy protect data security?"
sidebarTitle: "Data security"
description: "Understand the data security boundary, HTTPS transport, logs, usage records, and user-side security practices for LLMEasy API calls."
---

## Short answer

LLMEasy is an API gateway. Its main role is to forward your request to the selected upstream model and record the billing, usage, and troubleshooting information needed to operate the service.
