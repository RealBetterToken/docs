...
description: "Learn where Claude Code token usage comes from and how context, CLAUDE.md, MCP, model choice, and workflow design affect cost. Includes examples and fixes."
---
