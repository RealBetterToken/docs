...
description: "Use a CC Switch local route to run Codex group models in Claude Desktop."
---
...
<Info>
  This path is for **Codex group** API keys. Do not enter `{{openai-base-url}}` directly in Claude Desktop Gateway.
</Info>
