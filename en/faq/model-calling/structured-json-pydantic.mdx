...
description: "Validate JSON returned by an LLM with Pydantic, preserve the raw response, and handle repair and retries explicitly. Includes setup, examples, and fixes."
---
