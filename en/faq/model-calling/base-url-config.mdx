...
description: "Learn how Base URL, /v1 paths, API Key, and Model ID should match in Claude Code, Codex CLI, Cursor, Cline, and other tools. Includes examples and fixes."
---
