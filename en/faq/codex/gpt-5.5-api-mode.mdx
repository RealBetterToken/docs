...
As of April 24, 2026, some Codex versions may not let you select `gpt-5.5` directly when you use a custom API provider. This is a local model catalog limitation in Codex. It does not mean the LLMEasy `{{openai-base-url}}` endpoint is unavailable.
