...
description: "Understand Codex CLI sandboxing, approval modes, automatic review, local command boundaries, and how they differ from API provider settings for each project."
---
