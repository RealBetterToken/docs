...
LLMEasy only handles the model API request layer, such as API Key, Base URL, model routing, and usage records. It does not change Codex CLI sandbox or approval mode.
