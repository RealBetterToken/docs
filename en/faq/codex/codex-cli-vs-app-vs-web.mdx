...
description: "Compare Codex CLI, Codex App, and Codex Web / Cloud by runtime location, setup model, local permissions, and provider configuration. Includes setup guidance."
---
