...
description: "Distinguish a Codex plan usage limit from an API rate limit, usage cap, or BetterToken balance issue before you retry. Includes setup, examples, and fixes."
---
