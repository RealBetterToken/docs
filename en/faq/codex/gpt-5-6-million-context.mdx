...
description: "Set a one-million-token context budget and compaction threshold for GPT-5.6 Sol in config.toml, or enable it for one Codex CLI session. Practical guidance."
---
