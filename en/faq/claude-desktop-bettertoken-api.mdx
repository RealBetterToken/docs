---
title: "Connect Claude models to Claude Desktop with BetterToken"
sidebarTitle: "Claude Desktop"
description: "Configure the BetterToken Claude provider in Claude Desktop Gateway with a Base URL and API Key."
icon: "terminal"
---

This page covers direct Claude Desktop setup for the BetterToken **Claude provider** only. Enter your BetterToken API Key, `{{anthropic-base-url}}`, and `x-api-key`, then restart Claude Desktop.
