...
description: "Connect Kimi K3 to OpenCode through BetterToken. Set an API Key, Base URL, and the kimi-k3 Model ID with /connect or opencode.json. Includes setup guidance."
keywords:
  - "kimi k3 opencode"
  - "kimi k3 api"
