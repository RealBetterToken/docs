...
description: "After the general OpenCode setup, select the GLM provider, enter the exact Model ID, and verify that OpenCode calls the intended model. Practical guidance."
keywords:
  - "glm opencode"
  - "glm api opencode"
  - "opencode glm setup"
