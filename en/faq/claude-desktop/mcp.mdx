...
description: "Understand local MCP, remote MCP, connection status, and the difference between MCP and model APIs in Claude Desktop. Includes setup, examples, and fixes."
---
