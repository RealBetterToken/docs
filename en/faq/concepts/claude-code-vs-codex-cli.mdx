...
LLMEasy can act as the model API layer. Claude Code usually uses `{{anthropic-base-url}}`, while Codex CLI and other OpenAI-compatible tools usually use `{{openai-base-url}}`.
