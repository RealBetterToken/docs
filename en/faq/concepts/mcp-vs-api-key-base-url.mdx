...
description: "Compare MCP, API Keys, Base URLs, model protocols, and tool protocols so you can choose the correct integration, configure it, and avoid common setup errors."
---
