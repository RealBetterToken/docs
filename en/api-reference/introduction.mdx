...
|----------|-------|-------|
| `ANTHROPIC_BASE_URL` | `https://www.BetterToken.ai/v1` | Anthropic-compatible tools (Claude Code, etc.) |
| `ANTHROPIC_AUTH_TOKEN` | Your API Key | Claude Code authentication |
| `OPENAI_BASE_URL` | `https://www.BetterToken.ai/v1` | OpenAI SDK-compatible tools |
