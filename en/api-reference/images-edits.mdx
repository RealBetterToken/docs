...
description: "Generate or edit images from reference images with GPT Image 2 through BetterToken's OpenAI-compatible API. Includes setup steps, examples, and common fixes."
