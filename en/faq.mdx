...
<AccordionGroup>
  ...
  <Accordion title="Do I need to specify a model for Cursor and other tools?">
    Yes. Tools like Cursor require you to manually add and select a model. You can choose from the Claude series (e.g., `claude-sonnet-4-6`) or GPT series (e.g., `gpt-5.4`).
  ...
  <Accordion title="Authentication is failing — what should I check?">
    ...
    2. Confirm `base_url` is set to `https://www.BetterToken.ai/v1` (note: `BetterToken.ai`, not `bettertoken.ai`)
