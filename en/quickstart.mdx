...
<Steps>
  <Step title="Create an account">
    Visit the BetterToken registration page (`{{register-url}}`) to create an account.
  ...
  <Step title="Choose the Key group by tool type">
    ...
    <Warning>
      The **GPT Key group** can be used with Codex and external tools such as Cursor, Cline, Zed, and Roo Code.
    </Warning>
