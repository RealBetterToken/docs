...
description: "LLMEasy updated Claude Sonnet 5 on July 1, 2026 for Claude Code, coding agents, long-context work, and workflows that need a stronger Sonnet model."
tag: "NEW"
---

Release date: July 1, 2026

LLMEasy has updated the `Claude Sonnet 5` model entry. Check the <a href={"{{model-plaza-url}}"}>model plaza</a> for the currently available model ID and live pricing, then configure it through the Claude Code or external-tool setup guide that matches your client.
