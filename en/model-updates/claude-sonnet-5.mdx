...
The model plaza currently shows the following pricing for `claude-sonnet-5`:

| Billing item | Current price |
| --- | --- |
| Input | `$2.1000 / 1M tokens` |
| Output | `$10.5000 / 1M tokens` |

<Note>
  Pricing was checked on July 1, 2026. Actual billing follows the live price shown in the <a href={"{{model-plaza-url}}"}>model plaza</a>.
</Note>
...
- **Low migration cost**: If you already use Sonnet 4.6, most requests can move by changing the model ID to `claude-sonnet-5`
