...
description: "LLMEasy updated GPT Image 2 on April 29, 2026 for high-quality image generation, posters, marketing assets, and visual drafts."
tag: "NEW"
---

Release date: April 29, 2026

LLMEasy has added the `gpt-image-2` image generation model entry. Check the <a href={"{{model-plaza-url}}"}>model plaza</a> for the currently available model ID, then call it through the OpenAI-compatible image generation API.
