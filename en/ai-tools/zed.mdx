...
sidebarTitle: "Zed"
description: "Add BetterToken as an OpenAI-compatible provider in Zed, configure the Base URL, API Key, and model, and keep the key in the system keychain on macOS."
icon: "z"
---
