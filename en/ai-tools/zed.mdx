---
title: "How to connect Zed to the LLMEasy OpenAI-compatible API"
sidebarTitle: "Zed"
description: "Configure Zed with the LLMEasy API URL, API Key, and a GPT Key group model ID through an OpenAI-compatible provider."
icon: "z"
---
