---
title: "Connect Cursor to LLMEasy with a custom model"
sidebarTitle: "Cursor"
description: "Connect LLMEasy to Cursor with GPT Key group model IDs."
icon: "arrow-pointer"
---

When connecting LLMEasy to Cursor, use the OpenAI-compatible endpoint. External tools use the GPT Key group, so copy the current model ID from the <a href={"{{model-plaza-url}}"}>model plaza</a>.
