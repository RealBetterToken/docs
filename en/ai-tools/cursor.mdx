---
title: "Connect Cursor to BetterToken with a custom model"
sidebarTitle: "Cursor"
description: "Connect BetterToken to Cursor with GPT Key group model IDs."
icon: "arrow-pointer"
---

When connecting BetterToken to Cursor, use the OpenAI-compatible endpoint. External tools use the GPT Key group, so copy the current model ID from the <a href={"{{model-plaza-url}}"}>model plaza</a>.
