...
sidebarTitle: "Cline"
description: "Install Cline, configure the BetterToken Base URL and API key, choose a compatible provider model, and troubleshoot common errors. Includes setup guidance."
icon: "c"
---
