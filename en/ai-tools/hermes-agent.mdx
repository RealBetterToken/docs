---
title: "Connect Hermes Agent to BetterToken with a custom model"
sidebarTitle: "Hermes Agent"
description: "Connect BetterToken to Hermes Agent with GPT Key group models and the OpenAI-compatible protocol."
icon: "user-astronaut"
---
...
When connecting BetterToken, use a **GPT Key group** API Key and call models through the OpenAI-compatible endpoint.
...
<Tabs>
  ...
  <Tab title="CLI config">
    ...
    Replace `YOUR_BETTERTOKEN_API_KEY` with your BetterToken API Key, and replace `YOUR_GPT_MODEL_ID` with a GPT Key group model ID from the <a href={"{{model-plaza-url}}"}>model plaza</a>.
...
After migration, still review the Hermes Agent **Base URL**, API Key, and model ID. They should match `{{openai-base-url}}`, your BetterToken API Key, and a GPT Key group model ID.
