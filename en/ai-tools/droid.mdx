...
sidebarTitle: "Droid"
description: "Install Droid, configure the BetterToken Base URL and API key, choose a compatible provider model, and troubleshoot common errors. Includes setup guidance."
icon: "robot"
---
