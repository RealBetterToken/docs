---
title: "OpenClaw BetterToken setup guide"
...
2. If the BetterToken provider does not exist, add one that uses the Base URL `https://www.bettertoken.ai/v1` and sets `api: "openai-responses"`.
