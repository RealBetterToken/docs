---
title: "Connect OpenClaw to LLMEasy with a custom model"
sidebarTitle: "OpenClaw"
description: "Connect LLMEasy to OpenClaw, a multi-platform AI agent gateway."
icon: "paw"
---
...
2. If the LLMEasy provider does not exist, add one that uses the Base URL `{{openai-base-url}}` and sets `api: "openai-responses"`.
