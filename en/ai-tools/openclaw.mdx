...
description: "Configure OpenClaw models.providers, a BetterToken API Key, Base URL, OpenAI Responses or Chat Completions models, and validate the Gateway connection."
icon: "paw"
---
