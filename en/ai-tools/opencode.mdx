...
OpenCode connects to BetterToken with `@ai-sdk/openai-compatible`. Name the OpenCode provider **BetterToken** or **OpenAI Compatible**. GPT, Kimi, and GLM are model providers inside BetterToken, not OpenCode provider names.
