---
title: "MonkeyCode setup: installation, API key, Base URL, and custom models"
sidebarTitle: "MonkeyCode"
description: "Install MonkeyCode, configure the BetterToken Base URL and API key, choose a compatible provider model, and troubleshoot common errors."
icon: "monkey"
---

To connect MonkeyCode to BetterToken, prepare an API key, enter the Base URL shown below, and choose a current Model ID from the model plaza.
