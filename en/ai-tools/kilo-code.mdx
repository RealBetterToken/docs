---
title: "Connect Kilo Code to LLMEasy with a custom model"
sidebarTitle: "Kilo Code"
description: "Connect LLMEasy to Kilo Code with GPT Key group model IDs."
icon: "puzzle-piece"
---
...
<Steps>
  ...
  <Step title="Only configure extra headers when the official docs explicitly require them">
    The official Kilo Code material we checked mentions optional custom headers for OpenAI-compatible providers, but it does not treat `User-Agent` as a required LLMEasy setup step.
