...
- Prepare one current **GPT Key group** model ID for Codex, OpenCode, and OpenClaw. You can copy it from the BetterToken model plaza (`{{model-plaza-url}}`), or let CC Switch fetch it from `/v1/models`
...
<Tabs>
  <Tab title="Claude Code" id="claude-code">
    <Steps>
      ...
      <Step title="Handle model mapping based on your Key group">
        ...
        All of these models should use current **GPT Key group** model IDs from the BetterToken model plaza (`{{model-plaza-url}}`).
      </Step>
  ...
  <Tab title="OpenCode" id="opencode">
    <Steps>
      ...
      <Step title="Choose the default model">
        Use **Fetch Models** when possible. If you need to enter the model manually, use a current **GPT Key group** model ID from the BetterToken model plaza (`{{model-plaza-url}}`).
      </Step>
