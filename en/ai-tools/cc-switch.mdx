...
- Prepare one current **Codex group** model ID for Codex, OpenCode, and OpenClaw. You can copy it from the BetterToken [model plaza](https://www.bettertoken.ai/pricing), or let CC Switch fetch it from `/v1/models`
