...
CC Switch is a cross-platform desktop app for managing providers across Claude Code, Codex, Gemini CLI, OpenCode, and OpenClaw. This page shows you how to connect BetterToken to CC Switch for the four BetterToken paths already covered in this docs site: Claude Code, Codex, OpenCode, and OpenClaw.
...
- Prepare one current **Codex group** model ID for Codex, OpenCode, and OpenClaw. You can copy it from the BetterToken model plaza (`{{model-plaza-url}}`), or let CC Switch fetch it from `/v1/models`
...
<Tabs>
  <Tab title="Claude Code" id="claude-code">
    <Steps>
      ...
      <Step title="Handle model mapping based on your API Key group">
        ...
        All of these models should use current **Codex group** model IDs from the BetterToken model plaza (`{{model-plaza-url}}`).
      </Step>
  ...
  <Tab title="OpenCode" id="opencode">
    <Steps>
      ...
      <Step title="Choose the default model">
        Use **Fetch Models** when possible. If you need to enter the model manually, use a current **Codex group** model ID from the BetterToken model plaza (`{{model-plaza-url}}`).
      </Step>
...
- Use a **Codex group** model ID as the default model for Codex, OpenCode, and OpenClaw
