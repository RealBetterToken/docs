...
description: "Manage BetterToken providers, model mappings, and proxy settings for Claude Code, Claude Desktop, Codex CLI, OpenCode, and OpenClaw in CC Switch by project."
---
