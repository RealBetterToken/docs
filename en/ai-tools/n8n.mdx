---
title: "How to connect n8n to BetterToken custom models"
sidebarTitle: "n8n"
description: "Create an OpenAI credential in n8n with the BetterToken Base URL, API Key, and a GPT Key group model ID, then connect it to OpenAI Chat Model."
icon: "diagram-project"
---

To connect n8n to BetterToken, use the built-in **OpenAI credential** and **OpenAI Chat Model**. Set the Base URL to `{{openai-base-url}}`, use an API Key from the **GPT Key group**, and select the matching model from the model list.
