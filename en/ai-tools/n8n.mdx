...
sidebarTitle: "n8n"
description: "Connect n8n to BetterToken with a Base URL, API key, and compatible provider model, then verify the connection and fix common errors. Practical guidance."
