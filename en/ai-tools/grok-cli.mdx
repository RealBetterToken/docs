---
title: "Connect Grok CLI to LLMEasy with a custom model"
sidebarTitle: "Grok CLI"
description: "Connect LLMEasy to Grok CLI with GPT Key group model IDs."
icon: "g"
---

Grok CLI uses environment variables for API configuration. When connecting LLMEasy, use `{{openai-base-url}}` and a model ID from the GPT Key group.
