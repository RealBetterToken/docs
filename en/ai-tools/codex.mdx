  ...
  <Tab title="Manual setup">
    <Steps>
      <Step title="Confirm the default models">
        The config below uses `gpt-5.5` as the default model and `gpt-5.4` as the review model. If you need to switch models, open the BetterToken model plaza (`{{model-plaza-url}}`) and copy a currently available model ID from the **Codex group**.
      </Step>
