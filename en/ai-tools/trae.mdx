---
title: "Connect TRAE to LLMEasy with a custom model"
sidebarTitle: "TRAE"
description: "Connect LLMEasy to TRAE with GPT Key group model IDs."
icon: "bolt"
---
...
<Note>
  LLMEasy only supports TRAE through **GPT Key group** models. Do not use fixed Claude model names, and do not set the custom request URL to `{{openai-base-url}}`.
</Note>
