...
sidebarTitle: "TRAE"
description: "Install TRAE, configure the BetterToken Base URL and API key, choose a compatible provider model, and troubleshoot common errors. Includes setup guidance."
icon: "bolt"
---
