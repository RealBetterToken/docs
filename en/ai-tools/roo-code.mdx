---
title: "Roo Code"
description: "Connect BetterToken to Roo Code with Codex group model IDs."
icon: "r"
---
...
<Note>
  Roo Code's OpenAI Compatible provider still depends on OpenAI-style tool calling. If your version cannot set custom headers, missing the required UA may trigger `403 block` or `403 Forbidden`.
</Note>
