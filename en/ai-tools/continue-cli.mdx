...
description: "Install Continue CLI, configure the BetterToken Base URL and API key, choose a compatible provider model, and troubleshoot common errors. Practical guidance."
icon: "terminal"
---
