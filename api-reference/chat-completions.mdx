...
description: "Используйте OpenAI-compatible Chat Completions API BetterToken: полный URL запроса, Bearer API Key и примеры для curl, Python, JavaScript и отладки API."
openapi: "api-reference/openapi.llmeasy.json POST /v1/chat/completions"
---
