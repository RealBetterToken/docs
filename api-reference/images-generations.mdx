---
title: "API генерации изображений"
description: "Генерируйте изображения из текста через GPT Image 2 и OpenAI-compatible API BetterToken: API Key, Base URL, параметры, Python, JavaScript и ошибки API."
openapi: "api-reference/openapi.llmeasy.json POST /v1/images/generations"
---
