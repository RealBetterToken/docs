...
description: "Valida con Pydantic el JSON devuelto por un LLM, conserva la respuesta original y gestiona reparación y reintentos de forma explícita. En la práctica."
---
