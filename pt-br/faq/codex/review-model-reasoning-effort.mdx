...
description: "Entenda review_model, model_reasoning_effort, /review, /model e como essas configurações afetam o custo e a qualidade no Codex CLI. Com configuração e exemplos."
---
