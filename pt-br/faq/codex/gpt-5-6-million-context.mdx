...
description: "Configure um contexto de um milhão de tokens e o limite de compactação para GPT-5.6 Sol no config.toml ou apenas em uma sessão do Codex CLI. Com exemplos."
---
