...
description: "Entenda o cache de prompt, os campos de acerto de cache, as diferenças entre protocolos e como verificar se uma requisição usou tokens em cache. Na prática."
---
