...
description: "Configure models.providers do OpenClaw, uma BetterToken API Key, a Base URL e modelos OpenAI Responses ou Chat Completions, e valide o Gateway. Na prática."
icon: "paw"
---
