...
sidebarTitle: "Cursor"
description: "Instale o Cursor, configure a Base URL e a API Key do BetterToken, escolha um modelo de um provedor compatível e resolva erros comuns. Para seu projeto."
icon: "arrow-pointer"
---
