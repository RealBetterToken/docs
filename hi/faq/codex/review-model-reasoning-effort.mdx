...
description: "review_model, model_reasoning_effort, /review और /model समझें, तथा जानें कि ये settings Codex CLI में cost और quality को कैसे प्रभावित करती हैं। विस्तार से।"
---
