...
description: "Codex CLI sandboxing, approval modes, automatic review और local command boundaries समझें, तथा जानें कि वे API provider settings से कैसे अलग हैं। विस्तार से।"
---
