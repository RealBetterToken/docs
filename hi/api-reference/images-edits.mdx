...
किसी चुने हुए क्षेत्र में edit को निर्देशित करने के लिए वैकल्पिक `mask` file field जोड़ें। मौजूदा BetterToken endpoint एक `mask` PNG file पढ़ता है। बार-बार `mask[]` fields न भेजें।

- मूल image और mask का file format और pixel dimensions एक समान होना चाहिए। क्योंकि mask PNG होना चाहिए, दोनों files के लिए PNG इस्तेमाल करें। हर file 50 MB से छोटी होनी चाहिए।
...
यह छोटा Pillow check format, dimensions, Alpha channel और पूरी तरह transparent तथा opaque pixels की जांच करता है:
