...
description: "GPT-5.6 models अब उपलब्ध हैं, जिनमें Codex, external tools और multi-step agent workflows के लिए gpt-5.6-luna, gpt-5.6-sol और gpt-5.6-terra शामिल हैं। देखें।"
---
