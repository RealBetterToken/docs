...
description: "Проверяйте JSON от LLM через Pydantic, сохраняйте исходный ответ и явно обрабатывайте repair и повторные попытки. С настройкой, примерами и устранением ошибок."
---
