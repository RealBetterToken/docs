...
description: "Откуда берется token usage в Claude Code и как context, CLAUDE.md, MCP, model choice и workflow влияют на cost. С настройкой, примерами и устранением ошибок."
---
