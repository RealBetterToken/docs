...
description: "Что такое prompt caching, где смотреть cached tokens, чем отличаются protocols и как понять, был ли cache hit. С настройкой, примерами и устранением ошибок."
---
