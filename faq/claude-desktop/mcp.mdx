...
description: "Настройте local и remote MCP в Claude Desktop, проверьте connection status и разрешения инструментов, а также отличайте MCP от подключения model API верно."
---
