...
description: "Разберите sandbox, approval modes, automatic review, локальные границы команд и отличие этих настроек от API provider в Codex CLI. С настройкой и примерами."
---
