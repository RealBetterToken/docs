...
description: "Настройте allow, ask и deny через /permissions и settings.json, затем добавьте, проверьте и отладьте hooks Claude Code. С настройкой, примерами и ошибками."
---
