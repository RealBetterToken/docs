---
title: "Cursor 如何配置自定义 OpenAI API Key 和 Base URL？"
sidebarTitle: "Cursor 自定义 API"
description: "说明 Cursor 中 OpenAI-compatible API Key、Override OpenAI Base URL、custom model 和模型 ID 的配置边界。"
---
...
Cursor 这类外部工具通常走 OpenAI-compatible 接入。BetterToken 的 Base URL 是 `{{openai-base-url}}`，模型 ID 从<a href={"{{model-plaza-url}}"}>模型广场</a>的 **GPT 分组**复制。
