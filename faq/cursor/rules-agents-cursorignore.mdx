...
description: "Разберите Cursor Rules, AGENTS.md и .cursorignore для project context, rule inheritance и index control. С настройкой, примерами и устранением частых ошибок."
---
