...
console.log(`Validated ${targetUrls.length} unique BetterToken targets`);

if (expectRedirects) {
  console.log(`Validated ${redirectRows.length} LLMEasy permanent redirects`);
  console.log(`Validated ${goneRows.length} LLMEasy deleted pages`);
}
