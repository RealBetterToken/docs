...
export async function generateBetterTokenSitemap({
...
if (process.argv[1] && path.resolve(process.argv[1]) === fileURLToPath(import.meta.url)) {
  ...
  console.log(`Generated BetterToken hreflang sitemap at ${path.relative(rootDir, defaultOutputPath)}`);
}
