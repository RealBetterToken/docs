...
const hits = [];
let currentUrl = new URL('https://docs.llmeasy.ru/en/quickstart?_ym_debug=2');
...
assert.deepEqual(hits, [[
  110565477,
  'hit',
  'https://docs.llmeasy.ru/en/ai-tools/codex?_ym_debug=2',
  { title: 'Codex | LLMEasy' },
]]);
...
currentUrl = new URL('https://docs.llmeasy.ru/en/ai-tools/codex?_ym_debug=2');
currentPath = currentUrl.pathname;
...
console.log('LLMEasy Yandex Metrica SPA tracking check passed.');
