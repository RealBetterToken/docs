...
description: "Utilisez /permissions et settings.json pour configurer les règles allow, ask et deny, puis ajoutez, vérifiez et dépannez les hooks Claude Code. En pratique."
---
