...
description: "Configurez un contexte d’un million de tokens et le seuil de compaction de GPT-5.6 Sol dans config.toml, ou uniquement pour une session Codex CLI. Plus."
---
