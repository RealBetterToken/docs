...
模型广场当前显示 `claude-sonnet-5` 的价格如下：
...
<Note>
  价格读取时间为 2026-07-01。实际扣费请以<a href={"{{model-plaza-url}}"}>模型广场</a>实时显示为准。
</Note>
...
- **迁移成本较低**：如果你已经在使用 Sonnet 4.6，大多数请求可以直接把模型 ID 换成 `claude-sonnet-5`
