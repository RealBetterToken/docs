...
Для ошибок `401`, Base URL или model mapping откройте [инструкцию по Claude Code](/ru/ai-tools/claude-code). Для подтверждений команд и automation используйте диагностику permissions и hooks на этой странице.

## Связанные документы

- [Настройка Claude Code с BetterToken](/ru/ai-tools/claude-code)
...
- [MCP и API Key / Base URL в Claude Code](/ru/faq/concepts/mcp-vs-api-key-base-url)
