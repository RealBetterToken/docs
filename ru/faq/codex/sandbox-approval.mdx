...
BetterToken обрабатывает только model API request layer: API Key, Base URL, model routing и usage records. Он не меняет sandbox или approval mode в Codex CLI.
