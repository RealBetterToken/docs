...
俄罗斯区域站点使用 BetterToken 域名；对应的 Base URL、注册入口、控制台和模型广场都以 BetterToken 站点为准。

## 什么时候不需要 VPN

- 访问 BetterToken 网站和控制台
- 创建或管理 API Key
...
俄罗斯区域服务使用 BetterToken 域名。俄罗斯用户优先使用区域站点的注册链接、控制台和 API Base URL；这样可以减少支付、访问和网络链路上的不确定性。
