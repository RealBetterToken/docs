...
description: "LLMEasy 于 2026-07-01 更新 Claude Sonnet 5，适合 Claude Code、编码 Agent、长上下文任务和需要更高 Sonnet 能力的工作流。"
tag: "NEW"
---

发布日期：2026-07-01

LLMEasy 已更新 `Claude Sonnet 5` 相关模型入口。你可以在<a href={"{{model-plaza-url}}"}>模型广场</a>查看当前可用模型 ID 和实时价格，并按 Claude Code 或外部工具的接入文档配置。
