---
title: "Droid 自定义模型接入 LLMEasy 指南"
sidebarTitle: "Droid"
description: "在 Droid 中使用 LLMEasy，接入 GPT 分组模型。"
icon: "robot"
---
...
<Steps>
  ...
  <Step title="仅在官方文档明确要求时再配置额外 headers">
    当前我们没有查到 Droid 官方接入说明要求 LLMEasy 额外配置 `User-Agent`。默认先按页面中的 `Base URL`、API Key 和模型 ID 完成接入即可。
