---
title: "GitHub Copilot 自定义模型接入 LLMEasy 指南"
sidebarTitle: "GitHub Copilot"
description: "在 VS Code 的 GitHub Copilot Chat 中通过 Custom Endpoint 配置 LLMEasy API Key 和 Base URL。"
icon: "github"
---
  ...
  <Step title="输入名称">
    ...
    <Frame>
      <img
        ...
        alt="在 Group Name 输入框中填写 LLMEasy。"
        style={{ borderRadius: '0.5rem' }}
      />
    </Frame>
  </Step>
  ...
  <Step title="编辑 JSON 配置">
    ...
    <Frame>
      <img
        ...
        alt="在 chatLanguageModels.json 中配置 LLMEasy 模型 URL、toolCalling、vision 和 token 上限。"
        style={{ borderRadius: '0.5rem' }}
      />
    </Frame>
