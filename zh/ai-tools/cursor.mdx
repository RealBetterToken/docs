---
title: "Cursor 自定义模型接入 LLMEasy 指南"
sidebarTitle: "Cursor"
description: "在 Cursor 中使用 LLMEasy，接入 GPT 分组模型。"
icon: "arrow-pointer"
---

在 Cursor 中接入 LLMEasy 时，使用 OpenAI-compatible 协议入口。外部工具统一走 GPT 分组，请从<a href={"{{model-plaza-url}}"}>模型广场</a>复制当前可用的模型 ID。
