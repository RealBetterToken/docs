---
title: "Grok CLI 설정: 설치, API Key, Base URL 및 사용자 지정 모델"
sidebarTitle: "Grok CLI"
description: "Grok CLI를 설치하고 BetterToken Base URL 및 API Key를 설정한 다음 호환되는 provider model을 선택하고 일반적인 오류를 해결하세요."
icon: "g"
---
